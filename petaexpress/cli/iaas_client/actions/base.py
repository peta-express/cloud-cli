...
from petaexpress.cli.iaas_client.handler import IaasHandler
from petaexpress.cli.misc.utils import load_conf, send_request, get_expire_time
...
class BaseAction(object):
    ...
    def get_argument_parser(cls):
        parser = ArgumentParser(
                prog='petaexpress iaas %s' % cls.command,
                usage=cls.usage,
    ...
    def add_common_arguments(cls, parser):
        ...
        parser.add_argument('-f', '--config', dest='conf_file',
                action='store', type=str, default='~/.petaexpress/config.yaml',
